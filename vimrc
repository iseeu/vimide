set nocompatible    " Use Vim defaults (much better!), not compatible with basic vi
...
set linebreak		" change line dont break words
set autoread		" auto load file content if it has been modified by other program
...
" indent settings
set autoindent		"keep same indent with line above, aka. set ai
filetype plugin on
filetype plugin indent on
"set smartindent	"a complement script for 'autoindent', not really smart
"set cindent		"just C-like indent
...
"代码折叠
set foldmethod=syntax	"method=syntax/manual/indent/expr/diff/marker
set foldmarker={,}
"set foldlevel=100       "work with method=indent
set foldopen-=search	"dont open fold while searching
set foldopen-=undo
